...
Subscription.prototype._formatInput = function (args) {
  ...
  var formattedArgs = subscription.inputFormatter.map(
...
Subscription.prototype.subscribe = function () {
  ...
  if (this.lastBlock && _.isObject(this.options.params)) {
    ...
    payload.params[1].fromBlock = formatters.inputBlockNumberFormatter(
      this.lastBlock + 1,
    );
  }
  ...
  if (
    payload.params[0] === "logs" && _.isObject(payload.params[1]) &&
